...
public class PathApplication extends Application<PathConfiguration> {
    ...
    public void run(PathConfiguration configuration, Environment environment) throws SQLException {
        ...
        //pathDao.insertpaths("rohith");
        System.out.println(pathDao.getBy());

        final AudioResource AudioResource = new AudioResource(pathDao);
        environment.jersey().register(AudioResource);
        environment.jersey().register(resource);
        //int k;
        //AudioResource controling = new AudioResource();
        //k=controling.controlpath();
